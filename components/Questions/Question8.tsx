  ...
  return (
    <div className="flex flex-col">
      {/* <p className="text-[1.125rem] leading-[1.5rem] mb-2">
        Evaluate the expression x(2.5) for x = 2.6.
      </p> */}
      <div className="flex flex-wrap align-center gap-[1rem] items-center mb-11">
        <span>
          {' '}
          <p className="text-[1.5rem] leading-[1.5rem]">
            The expression x(2.15) is equal to
          </p>
        </span>
        ...
        />
        <span className="text-[1.5rem] leading-[1.5rem]">for x = 2.6</span>
      </div>
      ...
      <div className="mt-9">
        ...
        <CheckAnswerButton
          handleClick={() => {
            const val = handleQuestionActions('answer', answer, 7);
            if (val && val === 'correct') {
