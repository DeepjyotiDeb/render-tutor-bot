...
import StartConversation from '../Chatbar/components/StartConversation';
import { TopicSelect } from '../Chatbar/components/TopicSelect';
import {
  CloseSidebarButton,
  OpenSidebarButton,
} from './components/OpenCloseButton';

import CloudImage from '../../public/assets/clouds.png';
    ...
    <div>
      ...
      >
        ...
        <div className="flex items-center justify-center">
          <Image width={150} alt="logo" src={LogoImage} />
          {/* <button
